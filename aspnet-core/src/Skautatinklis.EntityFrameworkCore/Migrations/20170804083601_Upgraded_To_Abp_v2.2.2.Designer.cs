...
namespace Skautatinklis.Migrations
{
    ...
    partial class Upgraded_To_Abp_v222
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Skautatinklis.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Skautatinklis.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("Skautatinklis.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("Skautatinklis.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
